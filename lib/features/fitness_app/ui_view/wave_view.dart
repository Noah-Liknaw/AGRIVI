        ...
        builder: (_, __) => Stack(
          children: <Widget>[
            ClipPath(
              ...
              child: Container(
                decoration: BoxDecoration(
                  color: FitnessAppTheme.nearlyDarkGreen.withOpacity(0.5),
                  ...
                  gradient: LinearGradient(
                    colors: <Color>[
                      FitnessAppTheme.nearlyDarkGreen.withOpacity(0.2),
                      FitnessAppTheme.nearlyDarkGreen.withOpacity(0.5)
                    ],
            ...
            ClipPath(
              ...
              child: Container(
                decoration: BoxDecoration(
                  color: FitnessAppTheme.nearlyDarkGreen,
                  gradient: LinearGradient(
                    colors: <Color>[
                      FitnessAppTheme.nearlyDarkGreen.withOpacity(0.4),
                      FitnessAppTheme.nearlyDarkGreen
                    ],
                    begin: Alignment.topLeft,
                    end: Alignment.bottomRight,
                  ),
